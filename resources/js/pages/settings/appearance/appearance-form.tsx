...
import { type AppearanceFormValues, appearanceFormSchema } from "../data/schema";
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>{t("settings.appearance.font_description")}</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="space-y-1">
              ...
              <FormDescription>{t("settings.appearance.theme_description")}</FormDescription>
              <FormMessage />
              <RadioGroup
