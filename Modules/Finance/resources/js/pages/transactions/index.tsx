...
import type { Account, Category, PaginatedData, Transaction } from "@modules/Finance/types/finance";
...
export default function TransactionsIndex({
  ...
  const confirmDelete = () => {
    if (selectedTransaction) {
      router.delete(route("dashboard.finance.transactions.destroy", selectedTransaction.id), {
        onSuccess: () => {
  ...
  const selectableTransactions = transactions.data.filter((t) => !t.transfer_transaction_id);
  const isAllSelected =
      ...
      <Main>
        <div className="mb-4 md:flex items-center justify-between">
          <div className="mb-4">
            ...
            <p className="text-muted-foreground">{t("page.transactions.description")}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div className="p-4 border rounded-lg bg-background">
              <p className="text-sm text-muted-foreground">
                {t("page.transactions.total_transactions")}
              </p>
            ...
            <div className="p-4 border rounded-lg bg-background">
              <p className="text-sm text-muted-foreground">
                {t("page.transactions.total_expense")}
              </p>
        ...
        {transactions.data.length > 0 ? (
                        ...
                        <TableCell>
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              {!transaction.is_reconciled ? (
                                <DropdownMenuItem onClick={() => handleReconcile(transaction)}>
                                  <CheckCircle className="mr-2 h-4 w-4" />
                                  {t("action.mark_reconciled")}
                                </DropdownMenuItem>
                              ) : (
                                <DropdownMenuItem onClick={() => handleUnreconcile(transaction)}>
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-muted-foreground mb-4">{t("page.transactions.empty_description")}</p>
            <Button onClick={() => setShowForm(true)}>
        ...
        <AlertDialog open={showBulkDeleteDialog} onOpenChange={setShowBulkDeleteDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>
                {t("dialog.bulk_delete.title", { count: selectedIds.length })}
              </AlertDialogTitle>
              <AlertDialogDescription>
