import { Camera, Mic, Paperclip, Send, Square, Upload, X } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto">
        <div
          className={`relative rounded-2xl border shadow-xs focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-1 transition-all ${isDragging ? "border-primary border-dashed bg-primary/5 ring-2 ring-primary/20" : "bg-muted/30"}`}
        >
          {/* Drop zone overlay */}
          {isDragging && (
