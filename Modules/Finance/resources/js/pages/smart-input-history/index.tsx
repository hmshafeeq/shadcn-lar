      ...
      <Main>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {t("page.smart_input_history.description")}
              </p>
            </div>
          </div>
          <Button
            variant="outline"
            size="sm"
            onClick={() => router.visit(route("dashboard.finance.smart-input"))}
          >
        ...
        <div className="flex flex-wrap gap-3 mb-4">
          <Select
            ...
            onValueChange={(v) => applyFilter("input_type", v)}
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="text_image">
                {t("page.smart_input_history.type_text_image")}
              </SelectItem>
            </SelectContent>
          </Select>
                ...
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-right">
                      {t("page.smart_input_history.col_amount")}
                    </TableHead>
        ...
        <AlertDialog open={deleteId !== null} onOpenChange={(open) => !open && setDeleteId(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                {t("page.smart_input_history.delete_description")}
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
