...
import type { Product, ProductCategory, ProductFormData, ProductTag } from "@/types/ecommerce";
...
export default function EditProduct({ product, categories = [], tags = [] }: EditProductPageProps) {
  ...
  return (
    <AuthenticatedLayout
      title={t("page.ecommerce.products.edit.title", {
        name: product?.name || t("common.fields.product"),
      })}
    >
      <Main>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden items-center gap-2 md:ml-auto md:flex">
                ...
                <Button size="sm" onClick={() => handleSubmit()} disabled={processing}>
                  {processing
                    ? t("page.ecommerce.products.edit.updating")
                    : t("page.ecommerce.products.edit.submit")}
                </Button>
              </div>
            </div>
              ...
              <div className="grid auto-rows-max items-start gap-4 lg:gap-8">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {t("page.ecommerce.products.form.edit_details_description")}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
