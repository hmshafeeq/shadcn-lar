            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden items-center gap-2 md:ml-auto md:flex">
                <Button size="sm" onClick={() => handleSubmit()} disabled={processing}>
                  {processing
                    ? t("page.ecommerce.categories.edit.updating")
                    : t("page.ecommerce.categories.edit.button")}
                </Button>
              </div>
            </div>
              ...
              <div className="grid auto-rows-max items-start gap-4 lg:gap-8">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {t("page.ecommerce.categories.form.edit_details_description")}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid gap-6">
                      ...
                      <div className="grid gap-3">
                        ...
                        <Textarea
                          id="description"
                          placeholder={t("page.ecommerce.categories.form.description_placeholder")}
                          className="min-h-20"
