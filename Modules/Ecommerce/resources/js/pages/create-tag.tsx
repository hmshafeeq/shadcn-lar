...
export default function CreateTag({}: PageProps) {
  ...
  const handleSubmit = () => {
    ...
    router.post(route("dashboard.ecommerce.product-tags.store"), formData, {
      forceFormData: true,
      onSuccess: () => {
        setProcessing(false);
        toast({
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="hidden items-center gap-2 md:ml-auto md:flex">
                  <Button size="sm" onClick={() => handleSubmit()} disabled={processing}>
                    {processing
                      ? t("page.ecommerce.tags.create.creating")
                      : t("page.ecommerce.tags.create.button")}
                  </Button>
                </div>
              </div>
                ...
                <div className="grid auto-rows-max items-start gap-4 lg:gap-8">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        {t("page.ecommerce.tags.form.details_description")}
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
