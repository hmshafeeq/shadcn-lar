            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden items-center gap-2 md:ml-auto md:flex">
                ...
                <Button size="sm" onClick={() => handleSubmit()} disabled={processing}>
                  {processing
                    ? t("page.blog.categories.create.creating")
              ...
              <div className="grid auto-rows-max items-start gap-4 lg:gap-8">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {t("page.blog.categories.form.details_description")}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid gap-6">
                      ...
                      <div className="grid gap-3">
                        ...
                        <Input
                          id="slug"
                          type="text"
                          placeholder={t("page.blog.categories.form.slug_auto_placeholder")}
                          value={data.slug}
                          onChange={(e) => setData((prev) => ({ ...prev, slug: e.target.value }))}
                        />
                        <p className="text-xs text-muted-foreground">
                          {t("page.blog.categories.form.slug_hint")}
                        </p>
                      </div>
                      <div className="grid gap-3">
              ...
              <div className="grid auto-rows-max items-start gap-4 lg:gap-8">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {t("page.blog.categories.form.parent_description")}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Select
